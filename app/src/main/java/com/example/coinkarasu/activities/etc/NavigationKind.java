...
public enum NavigationKind {
    ...
    zaif(R.string.nav_zaif, R.string.header_zaif, R.string.tab_zaif, R.string.summary_zaif, R.id.nav_zaif, R.color.colorZaif, R.color.colorZaifDark, R.color.state_nav_zaif, R.array.zaif_all_symbols, new Exchange[]{}, R.drawable.ic_nav_zaif),
    jpy_toplist(R.string.nav_jpy_toplist, R.string.header_jpy_toplist, R.string.tab_jpy_toplist, R.string.summary_jpy_toplist, R.id.nav_jpy_toplist, R.color.colorJpyToplist, R.color.colorJpyToplistDark, R.color.state_nav_jpy_toplist, R.array.jpy_toplist_symbols, new Exchange[]{Exchange.cccagg}, R.drawable.ic_nav_jpy),
    usd_toplist(R.string.nav_usd_toplist, R.string.header_usd_toplist, R.string.tab_usd_toplist, R.string.summary_usd_toplist, R.id.nav_usd_toplist, R.color.colorUsdToplist, R.color.colorUsdToplistDark, R.color.state_nav_usd_toplist, R.array.usd_toplist_symbols, new Exchange[]{Exchange.cccagg}, R.drawable.ic_nav_usd),
    eur_toplist(R.string.nav_eur_toplist, R.string.header_eur_toplist, R.string.tab_eur_toplist, R.string.summary_eur_toplist, R.id.nav_eur_toplist, R.color.colorEurToplist, R.color.colorEurToplistDark, R.color.state_nav_eur_toplist, R.array.eur_toplist_symbols, new Exchange[]{Exchange.cccagg}, R.drawable.ic_nav_eur),
    btc_toplist(R.string.nav_btc_toplist, R.string.header_btc_toplist, R.string.tab_btc_toplist, R.string.summary_btc_toplist, R.id.nav_btc_toplist, R.color.colorBtcToplist, R.color.colorBtcToplistDark, R.color.state_nav_btc_toplist, R.array.btc_toplist_symbols, new Exchange[]{Exchange.cccagg}, R.drawable.ic_nav_btc),
    edit_tabs(R.string.nav_edit_tabs, R.string.header_edit_tabs, R.string.tab_edit_tabs, R.string.summary_edit_tabs, R.id.nav_edit_tabs, R.color.colorEditTabs, R.color.colorEditTabsDark, R.color.state_nav_edit_tabs, -1, new Exchange[]{}, R.drawable.ic_nav_playlist_add);
