...
public enum NavigationKind {
    ...
    bitflyer(R.string.nav_bitflyer, R.string.tab_bitflyer, R.string.summary_bitflyer, R.id.nav_bitflyer, R.color.colorBitflyer, R.color.colorBitflyerDark, R.color.state_nav_bitflyer, R.array.bitflyer_all_symbols, new Exchange[]{}, R.drawable.ic_nav_bitflyer),
    coincheck(R.string.nav_coincheck, R.string.tab_coincheck, R.string.summary_coincheck, R.id.nav_coincheck, R.color.colorCoincheck, R.color.colorCoincheckDark, R.color.state_nav_coincheck, R.array.coincheck_all_symbols, new Exchange[]{Exchange.coincheck}, R.drawable.ic_nav_coincheck),
    zaif(R.string.nav_zaif, R.string.tab_zaif, R.string.summary_zaif, R.id.nav_zaif, R.color.colorZaif, R.color.colorZaifDark, R.color.state_nav_zaif, R.array.zaif_all_symbols, new Exchange[]{}, R.drawable.ic_nav_zaif),
