...
public enum NavigationKind {
    ...
    btc_toplist(R.string.nav_btc_toplist, R.string.tab_btc_toplist, R.string.summary_btc_toplist, R.id.nav_btc_toplist, R.color.colorBtcToplist, R.color.colorBtcToplistDark, R.color.state_nav_btc_toplist, R.array.btc_toplist_symbols, new String[]{"cccagg"}),
    edit_tabs(R.string.nav_edit_tabs, R.string.tab_edit_tabs, R.string.summary_edit_tabs, R.id.nav_edit_tabs, R.color.colorEditTabs, R.color.colorEditTabsDark, R.color.state_nav_edit_tabs, -1, new String[]{});
    ...
    NavigationKind(int navStrResId, int tabStrResId, int summaryStrResId, int navResId, int colorResId, int colorDarkResId,
                   int colorStateResId, int symbolsResId, String[] exchanges) {
