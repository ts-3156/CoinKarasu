 ...
 */
public class TestSubscriptionDelegate extends UiManagingDelegate {
    public static final String SKU_ID = "test_subscription";

    public TestSubscriptionDelegate(BillingProvider billingProvider) {
