...
public enum NavigationKind {
    ...
    japan(R.string.nav_japan, R.string.header_japan, R.string.tab_japan, R.string.summary_japan, R.id.nav_japan, R.color.colorNavJapan, R.color.colorNavJapanDark, R.color.state_nav_japan, R.array.japan_all_symbols, new Exchange[]{Exchange.bitflyer, Exchange.coincheck, Exchange.zaif}, new Section[]{new Section(Exchange.bitflyer, CoinKind.none), new Section(Exchange.coincheck, CoinKind.none), new Section(Exchange.zaif, CoinKind.none)}, R.drawable.ic_nav_japan, R.anim.progress_japan, true),
    bitflyer(R.string.nav_bitflyer, R.string.header_bitflyer, R.string.tab_bitflyer, R.string.summary_bitflyer, R.id.nav_bitflyer, R.color.colorBitflyer, R.color.colorBitflyerDark, R.color.state_nav_bitflyer, R.array.bitflyer_all_symbols, new Exchange[]{}, new Section[]{}, R.drawable.ic_nav_bitflyer, R.anim.progress_bitflyer, false),
    coincheck(R.string.nav_coincheck, R.string.header_coincheck, R.string.tab_coincheck, R.string.summary_coincheck, R.id.nav_coincheck, R.color.colorCoincheck, R.color.colorCoincheckDark, R.color.state_nav_coincheck, R.array.coincheck_all_symbols, new Exchange[]{Exchange.coincheck}, new Section[]{new Section(Exchange.coincheck, CoinKind.trading), new Section(Exchange.coincheck, CoinKind.sales)}, R.drawable.ic_nav_coincheck, R.anim.progress_coincheck, true),
    zaif(R.string.nav_zaif, R.string.header_zaif, R.string.tab_zaif, R.string.summary_zaif, R.id.nav_zaif, R.color.colorZaif, R.color.colorZaifDark, R.color.state_nav_zaif, R.array.zaif_all_symbols, new Exchange[]{}, new Section[]{}, R.drawable.ic_nav_zaif, R.anim.progress_zaif, false),
    jpy_toplist(R.string.nav_jpy_toplist, R.string.header_jpy_toplist, R.string.tab_jpy_toplist, R.string.summary_jpy_toplist, R.id.nav_jpy_toplist, R.color.colorJpyToplist, R.color.colorJpyToplistDark, R.color.state_nav_jpy_toplist, R.array.jpy_toplist_symbols, new Exchange[]{Exchange.cccagg}, new Section[]{new Section(Exchange.cccagg, CoinKind.none)}, R.drawable.ic_nav_jpy, R.anim.progress_jpy_toplist, true),
    usd_toplist(R.string.nav_usd_toplist, R.string.header_usd_toplist, R.string.tab_usd_toplist, R.string.summary_usd_toplist, R.id.nav_usd_toplist, R.color.colorUsdToplist, R.color.colorUsdToplistDark, R.color.state_nav_usd_toplist, R.array.usd_toplist_symbols, new Exchange[]{Exchange.cccagg}, new Section[]{new Section(Exchange.cccagg, CoinKind.none)}, R.drawable.ic_nav_usd, R.anim.progress_usd_toplist, false),
    eur_toplist(R.string.nav_eur_toplist, R.string.header_eur_toplist, R.string.tab_eur_toplist, R.string.summary_eur_toplist, R.id.nav_eur_toplist, R.color.colorEurToplist, R.color.colorEurToplistDark, R.color.state_nav_eur_toplist, R.array.eur_toplist_symbols, new Exchange[]{Exchange.cccagg}, new Section[]{new Section(Exchange.cccagg, CoinKind.none)}, R.drawable.ic_nav_eur, R.anim.progress_eur_toplist, false),
    btc_toplist(R.string.nav_btc_toplist, R.string.header_btc_toplist, R.string.tab_btc_toplist, R.string.summary_btc_toplist, R.id.nav_btc_toplist, R.color.colorBtcToplist, R.color.colorBtcToplistDark, R.color.state_nav_btc_toplist, R.array.btc_toplist_symbols, new Exchange[]{Exchange.cccagg}, new Section[]{new Section(Exchange.cccagg, CoinKind.none)}, R.drawable.ic_nav_btc, R.anim.progress_btc_toplist, true),
    edit_tabs(R.string.nav_edit_tabs, R.string.header_edit_tabs, R.string.tab_edit_tabs, R.string.summary_edit_tabs, R.id.nav_edit_tabs, R.color.colorEditTabs, R.color.colorEditTabsDark, R.color.state_nav_edit_tabs, -1, new Exchange[]{}, new Section[]{}, R.drawable.ic_nav_playlist_add, R.anim.progress_edit_tabs, true);
